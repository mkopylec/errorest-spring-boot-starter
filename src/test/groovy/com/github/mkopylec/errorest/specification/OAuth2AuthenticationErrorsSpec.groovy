...
class OAuth2AuthenticationErrorsSpec extends BasicSpec {
    ...
    def "Should get full error from #uri request for 'Accept: #acceptHeader' header"() {
        ...
        where:
        uri                                       | acceptHeader
        '/controller/oauth2-authentication-error' | APPLICATION_JSON_VALUE
        '/controller/oauth2-authentication-error' | APPLICATION_XML_VALUE
    }
